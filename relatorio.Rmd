...
tabela_freq_comp <- data.frame(
  ...
  'Competência 1' = paste0(round(100 * as.vector(freq_rel_comp1), 2), "%"),
  'Competência 2' = paste0(round(100 * as.vector(freq_rel_comp2), 2), "%"),
  'Competência 3' = paste0(round(100 * as.vector(freq_rel_comp3), 2), "%"),
  'Competência 4' = paste0(round(100 * as.vector(freq_rel_comp4), 2), "%"),
  'Competência 5' = paste0(round(100 * as.vector(freq_rel_comp5), 2), "%"),
  check.names = FALSE
)
