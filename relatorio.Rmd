...
<!-- Língua Estrangeira -->
# Análise da Escolha da Língua Estrangeira

**Gráfico 3:** Escolha das Línguas Estrangeiras
...
```
Observa-se, a partir do gráfico, que aproximadamente 55\% dos participantes escolheu a opção "inglês" para a prova de língua estrangeira e 45\% dos participantes escolheu "espanhol", o que evidencia que a maior parte dos estudantes optou pela língua inglesa. Por meio disso, é possível afirmar que, apesar da semelhança entre as línguas portuguesa e espanhola, a maioria dos participantes escolheu o inglês, refletindo o maior investimento no ensino dessa língua no Brasil.
...
* A maior parte dos participantes que teve a redação zerada não escreveu ou escreveu insuficientemente (54,2\% em branco e 8,54\% texto insuficiente)

* 19,97\% dos participantes não entendeu completamente o tema e teve redação zerada por fuga ao tema

* 11,01\% não foi capaz de relacionar o tema a conhecimentos prévios e copiou os textos motivadores.
...
A tabela apresenta a relação entre as notas e a frequência relativa da aparição da mesma em cada uma das 5 competências da redação, em redações que não foram zeradas.

## 2.1 Constatações da Tabela

Ao comparar as frequências das notas em todas as competências, as principais constatações são

* A competência com maior taxa de 0 é a competência 5 (6,67\%)

* A competência 1 possui a maior parte das notas concentradas entre 100 e 160 (com porcentagens mais significativas, entre 13,92\% e 37,04\%)

* A competência 1 é a única cuja taxa de notas 200 é significativamente menor

* A competência 5 possui maior distribuição de notas que as demais (todas as porcentagens estão acima de 2\%)

* A competência 2 é a competência com maior taxa de notas entre 120 e 200 (93,09\% das notas está nessa faixa)".

## 2.2 Constatações do Boxplot

O boxplot representa, graficamente, as informações presentes na tabela. Os pontos indicam valores que estão fora da concentração de resultados, mas que tiveram aparição (outliers).

* A competência 1 é a que possui menor dispersão, ou seja, a maioria dos resultados está concentrada em uma faixa pequena (100 a 160) e possui outliers em todas as notas fora dessa faixa

* A competência 2 possui concentração de notas mais altas que as demais, o que é evidenciado por abranger notas mais altas e não possui outliers, ou seja, todos os resultados estão na faixa estipulada

* A competência 5 possui maior dispersão, ou seja, abrange todas as notas possíveis e está mais distribuida.


**Tabela 8:** Frequência - Notas da Redação
...
names(freq_abs_red) <- c("0 - 100", "100 - 200", "200 - 300", "300 - 400", "400 - 500", "500 - 600", "600 - 700", "700 - 800", "800 - 900", "900 - 1000")
...
O gráfico relaciona o comportamento da frequência dos intervalos das notas da redação (presentes na tabela 3), indicado pelas barras, com o comportamento da normal, linha, para a verificação da semelhança entre ambos.

* É possível observar que a maior frequência de aparição dos valores converge para o centro, enquanto diminui ao se aproximar das extremidades, o que se assemelha ao comportamento teórico da normal.
