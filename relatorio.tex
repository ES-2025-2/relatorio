...
A partir da Tabela 1, observa-se a distribuição dos participantes em
...
A Tabela 2 apresenta a distribuição das notas de Ciências da Natureza em
...
\begin{verbatim}
## Warning: Removed 132654 rows containing non-finite outside the scale range
## (`stat_bin()`).
\end{verbatim}
...
\midrule
Prova padrão & 100\% & 300640\\
\bottomrule
\end{tabular}

\textbf{Gráfico 2:} Proporção de Provas com Acessibilidade

\includegraphics[width=\linewidth]{relatorio_files/figure-latex/grafico-acessibilidade-1}
